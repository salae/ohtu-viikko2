...
public class Kauppavarasto implements Varasto {

//    private static Kauppavarasto instanssi;

//    public static Kauppavarasto getInstance() {
//        if (instanssi == null) {
//            instanssi = new Kauppavarasto();
//        }
//
//        return instanssi;
//    }
    ...
    public Kauppavarasto(KirjanpitoInterface k) {
        kirjanpito = k;
